...
/**
 * Created by sony on 13-12-2017.
 */
public class MapperUtils {

//Add here your key which access in notification to open your class.
    ...
    public static final String LAUNCH_SETTINGS = "appsetting";
    public static final String LAUNCH_CALLER_ID = "mobiletracker";
    public static final String LAUNCH_BACKUP = "backup";
    public static final String LAUNCH_RECORDING = "allrecordings";
    public static final String LAUNCH_MORE = "more";

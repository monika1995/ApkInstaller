...
public class InlineCarouselCardMediaView
    ...
    public void setUpView() {
        ...
        inflater.inflate(R.layout.ad_applovin_card_media_view, this, true);
    ...
    private void bindViews() {
        fallbackImageView = findViewById(R.id.applovin_media_image);
        replayOverlay = findViewById(R.id.applovin_media_replay_overlay);
    }
